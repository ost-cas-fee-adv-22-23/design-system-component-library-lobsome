...
const Template: Story = () => (
    <div>
        ...
        <br />
        <Label size={LabelSizes.xl}>Label XL</Label>
        <Label size={LabelSizes.l}>Label L</Label>
        <Label size={LabelSizes.m}>Label M</Label>
        <Label size={LabelSizes.s}>Label S</Label>
    </div>
);
